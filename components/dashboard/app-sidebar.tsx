...
export function AppSidebar(props: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar collapsible="offcanvas" {...props}>
      <SidebarHeader className="flex h-13.75 z-60 items-start justify-center border-b bg-sidebar">
        <Link href="/overview" className="flex w-full items-center justify-start px-2 gap-3">
