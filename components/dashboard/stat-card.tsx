...
export function StatCard({
  ...
  const TrendIcon = isNeutral ? MinusIcon : isPositive ? TrendingUpIcon : TrendingDownIcon
    ...
    <Card data-slot="stat-card">
      <CardContent className="flex flex-col gap-3 p-4">
        <div className="flex items-start justify-between">
          <div className={cn("flex p-2 items-center justify-center rounded-lg bg-muted", styles.icon)}>
